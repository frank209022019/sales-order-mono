...
namespace SalesOrder.Database.Migrations
{
    ...
    [Migration("20230221172816_UpdateOrderTableWithRelationships")]
    partial class UpdateOrderTableWithRelationships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SalesOrder.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2020, 5, 27, 19, 28, 16, 76, DateTimeKind.Local).AddTicks(2576),
                        ...
                        new
                        {
                            ...
                            CategoryCode = "CAT#2",
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 19, 28, 16, 76, DateTimeKind.Local).AddTicks(2579),
                        ...
                        new
                        {
                            ...
                            CategoryCode = "CAT#3",
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 19, 28, 16, 76, DateTimeKind.Local).AddTicks(2580),
            ...
            modelBuilder.Entity("SalesOrder.Database.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            CustomerCode = "CUS#1",
                            DateCreated = new DateTime(2020, 5, 27, 19, 28, 16, 76, DateTimeKind.Local).AddTicks(1907),
                        ...
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            CustomerCode = "CUS#2",
                            DateCreated = new DateTime(2020, 5, 27, 19, 28, 16, 76, DateTimeKind.Local).AddTicks(1915),
            ...
            modelBuilder.Entity("SalesOrder.Database.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 19, 28, 16, 76, DateTimeKind.Local).AddTicks(3259),
                        ...
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 19, 28, 16, 76, DateTimeKind.Local).AddTicks(3263),
                        ...
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 19, 28, 16, 76, DateTimeKind.Local).AddTicks(3265),
            ...
            modelBuilder.Entity("SalesOrder.Database.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 19, 28, 16, 76, DateTimeKind.Local).AddTicks(1060),
                            FirstName = "System",
                            IsActive = true,
                            LastName = "User",
                            UserCode = "USR#1"
