...
namespace SalesOrder.Database.Migrations
{
    ...
    [Migration("20230221062704_AddOrderFields")]
            ...
            modelBuilder.Entity("SalesOrder.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2020, 5, 27, 8, 27, 4, 452, DateTimeKind.Local).AddTicks(919),
                        ...
                        new
                        {
                            ...
                            CategoryCode = "CAT#2",
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 8, 27, 4, 452, DateTimeKind.Local).AddTicks(922),
                        ...
                        new
                        {
                            ...
                            CategoryCode = "CAT#3",
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 8, 27, 4, 452, DateTimeKind.Local).AddTicks(924),
            ...
            modelBuilder.Entity("SalesOrder.Database.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            CustomerCode = "CUS#1",
                            DateCreated = new DateTime(2020, 5, 27, 8, 27, 4, 452, DateTimeKind.Local).AddTicks(135),
                        ...
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            CustomerCode = "CUS#2",
                            DateCreated = new DateTime(2020, 5, 27, 8, 27, 4, 452, DateTimeKind.Local).AddTicks(139),
            ...
            modelBuilder.Entity("SalesOrder.Database.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 8, 27, 4, 452, DateTimeKind.Local).AddTicks(1769),
                        ...
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 8, 27, 4, 452, DateTimeKind.Local).AddTicks(1775),
                        ...
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 8, 27, 4, 452, DateTimeKind.Local).AddTicks(1799),
            ...
            modelBuilder.Entity("SalesOrder.Database.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = new Guid("418eca24-a89f-4310-a8a0-6d12dd96dc6a"),
                            DateCreated = new DateTime(2020, 5, 27, 8, 27, 4, 451, DateTimeKind.Local).AddTicks(9203),
                            FirstName = "System",
                            IsActive = true,
                            LastName = "User",
                            UserCode = "USR#1"
